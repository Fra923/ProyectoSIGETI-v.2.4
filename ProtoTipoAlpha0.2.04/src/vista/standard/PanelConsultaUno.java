...
public class PanelConsultaUno extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        PanelInfoTicket = new java.awt.Panel();
        ...
        PanelInfoTicket.setBackground(new java.awt.Color(204, 204, 204));
        ...
        PanelInfoTicketLayout.setHorizontalGroup(
            ...
            .addGroup(PanelInfoTicketLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(textArea1, javax.swing.GroupLayout.DEFAULT_SIZE, 635, Short.MAX_VALUE)
                .addContainerGap())
        );
        PanelInfoTicketLayout.setVerticalGroup(
            PanelInfoTicketLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PanelInfoTicketLayout.createSequentialGroup()
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(this, "¿Desea finalizar la consulta?", null, JOptionPane.YES_NO_OPTION)) {
               Ventana.obtenerInstancia().ventanaPrincipal();        
        }
    ...
    private java.awt.Panel PanelInfoTicket;
